...
- Alembic migrations (16 revisions: 001–008, 010–017; 009 was never created)
...
- Total: 753 unit tests + 34 integration tests + 10 E2E tests

### What's next
- Phase 23b: insider Form 4 scraper, `insider_transactions` table, gated `insider_score`, stock-detail insider section
...
backend/           Python backend (FastAPI + Celery + SQLAlchemy)
  ...
  worker/          Celery application
    ...
    beat_schedule  Cron schedule (*/5 health, :00 scrape, :05 market data, :10 options, :12 CBOE, :15 sentiment, :30 signals, :35 paper portfolio + matview refresh, :45 outcomes, 21:30 portfolio snapshot, 3AM maintenance, 4AM weights, 4:30AM ML training)
  ...
  tests/           pytest test suite (753 unit tests + 34 integration tests)
